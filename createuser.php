        ...
        <div class="login-page">
          <div class="form">
            ...
            <form class="login-form">
              ...
              <input type="number" placeholder="Enter your contact no" name="contno" required/>
              <input type="email" placeholder="Enter your email" name="eml" required/>
...
if (isset($_POST) && $_POST){
 ...
 $query = "INSERT into newacc(username,password,contactno,mail)VALUES('$username','$password','$contact','$email');"; 
